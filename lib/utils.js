...
exports.mergeResponseInterceptorsMethods = exports.mergeRequestInterceptorsMethods = void 0;
var mergeRequestInterceptorsMethods = function (methods) {
    return function (endpoint) {
        var finalEndpoint = endpoint;
        methods.forEach(function (method) {
            var _endpoint = method(finalEndpoint);
...
var mergeResponseInterceptorsMethods = function (methods) {
    return function (response) {
        return new Promise(function (resolve, reject) { return __awaiter(void 0, void 0, void 0, function () {
            var finalInterceptorResponse, _i, methods_1, method, interceptorResponse, error_1;
