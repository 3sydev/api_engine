        ...
        this.getApi = function (type) {
            ...
            var result = {
                ...
                statusCodesActions: ignoreGlobalParams.includes('statusCodesActions')
                    ...
                    : (0, utils_1.generateGlobalArrayWithOverrides)(globals.statusCodesActions, api.statusCodesActions),
                errorMessages: ignoreGlobalParams.includes('errorMessages') ? api.errorMessages : (0, utils_1.generateGlobalArrayWithOverrides)(globals.errorMessages, api.errorMessages),
            };
            return result;
        };
