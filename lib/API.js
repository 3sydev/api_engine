    ...
    function API(apiConstants) {
        ...
        this.getApi = function (type) {
            ...
            var result = {
                ...
                stackTraceLogExtraParams: ignoreGlobalParams.includes('stackTraceLogExtraParams') ? api.stackTraceLogExtraParams : __assign(__assign({}, globals.stackTraceLogExtraParams), api.stackTraceLogExtraParams),
        ...
        this.useFetch = function (requestUrl, requestInit, requestApi) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var startTimestamp, response, responseBody, errorMessage, responseClone, error_1, error_2, stackTrace;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 8:
                            ...
                            return [3 /*break*/, 10];
                        case 9:
                            stackTrace = this.generateStackTraceCallLog(requestUrl, requestInit, startTimestamp, response, responseBody, errorMessage, requestApi.stackTraceLogExtraParams);
        ...
        this.call = function (type, parameters) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var defaultParameters, internalParameters, requestApi_1, requestUrl_1, requestInit_1, useFetchCall, _a, response, responseBody, retryCondition, result, interceptorResponse, finalResult, error_3;
                var _this = this;
