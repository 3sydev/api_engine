...
var API = /** @class */ (function () {
    function API(apiConstants, stackTraceLogCallback) {
        var _this = this;
        ...
        this.generateApiBasedOnRequestInterceptor = function (api) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var globals, ignoreGlobalParams, newApi, _a, _b, error_1;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _c.trys.push([0, 5, , 6]);
                            globals = this.apiConstants.globalParams;
                            ignoreGlobalParams = api.ignoreGlobalParams;
                            _a = [__assign({}, api)];
                            if (!ignoreGlobalParams.includes('requestInterceptor')) return [3 /*break*/, 2];
                            return [4 /*yield*/, api.requestInterceptor(api)];
                        case 1:
                            _b = _c.sent();
                            return [3 /*break*/, 4];
                        case 2: return [4 /*yield*/, (0, utils_1.mergeRequestInterceptorsMethods)([globals.requestInterceptor, api.requestInterceptor])(api)];
                        case 3:
                            _b = _c.sent();
                            _c.label = 4;
                        case 4:
                            newApi = __assign.apply(void 0, _a.concat([(_b)]));
                            resolve(newApi);
                            return [3 /*break*/, 6];
                        case 5:
                            error_1 = _c.sent();
        ...
        this.getApi = function (type, parameters) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var apis, globals, _api, api, ignoreGlobalParams, parametersRequest, result, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            apis = this.apiConstants.endpoints;
                            globals = this.apiConstants.globalParams;
                            _api = apis[type];
                            if (!_api)
                                throw new Error('Api type not defined');
                            return [4 /*yield*/, this.generateApiBasedOnRequestInterceptor(_api)];
                        case 1:
                            api = _a.sent();
                            ...
                            result = {
                                ...
                                requestInterceptor: ignoreGlobalParams.includes('requestInterceptor')
                                    ...
                                    : (0, utils_1.mergeRequestInterceptorsMethods)([globals.requestInterceptor, api.requestInterceptor]),
        ...
        this.useFetch = function (requestUrl, requestApi) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var startTimestamp, response, responseBody, errorMessage, responseClone, _a, error_3, error_4, stackTrace;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 5:
                            error_3 = _b.sent();
                            console.warn('error getting response body for stack trace log:', error_3);
                            return [3 /*break*/, 7];
                        case 6:
        ...
        this.call = function (type, parameters) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var defaultParameters, internalParameters, requestApi_1, requestUrl_1, useFetchCall, _a, response, responseBody, retryCondition, result, interceptorResponse, finalResult, error_5;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.getApi(type, internalParameters)];
                        case 1:
                            requestApi_1 = _b.sent();
                        ...
                        case 4:
                            ...
                            _b.label = 5;
                        case 5: return [4 /*yield*/, requestApi_1.responseInterceptor(result)];
                        case 6:
        ...
        this.manageRetry = function (requestApi, useFetchCall) {
            return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                var resolved, result, numberOfRetry, retriedTimes, retriedConditions, i, _a, response, responseBody, error_6, error_7;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 7, , 8]);
